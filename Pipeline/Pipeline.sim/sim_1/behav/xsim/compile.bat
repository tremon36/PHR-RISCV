...
REM
REM Generated by Vivado on Tue Apr 26 16:53:11 +0200 2022
...
echo "xvhdl --incr --relax -prj TEST_DECODE_vhdl.prj"
call xvhdl  --incr --relax -prj TEST_DECODE_vhdl.prj -log xvhdl.log
