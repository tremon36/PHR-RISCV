...
REM
REM Generated by Vivado on Thu Apr 28 18:28:48 +0200 2022
...
echo "xvhdl --incr --relax -prj TEST_PRUEBA_vhdl.prj"
call xvhdl  --incr --relax -prj TEST_PRUEBA_vhdl.prj -log xvhdl.log
