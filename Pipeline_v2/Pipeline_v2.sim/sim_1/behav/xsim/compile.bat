...
REM
REM Generated by Vivado on Fri Jun 03 18:08:07 +0200 2022
...
echo "xvhdl --incr --relax -prj Test_EXE_vhdl.prj"
call xvhdl  --incr --relax -prj Test_EXE_vhdl.prj -log xvhdl.log
